...
public:
    ...
    double traLoiCauHoi(vector<CauHoi> danhSachCauHoi) const {
        int n;
        double diemThi = 0;
        for (auto& ch : danhSachCauHoi) {
            cout << ch.id << ". " << ch.noiDung << endl;
...
public:
    ...
    void addTeacher() {
        ...
        GiaoVien t;
        t.setId(inputInt("Nhap ID giao vien: ")) ;
        ...
        t.getUsername() = inputLine("Nhap username: ");
...
int main() {
    ...
    QuanLyNguoiDung ql;
    QuanLyThi thi;
    HocSinh hs(665, "Hong", "123456", "Nguyen Thi Hong", "KTOT", "Nu", "20/02/2007", "00", 0.0, 123456);
